...
test('Purchase Electro Voucher - Savings account (Predefined amount) - R50', async ({ page }) => {
    ...
    await page.getByRole('button', { name: 'Continue' }).click();
    await page.locator('li > .km-listview-wrapper > .cap-list-template > li > .cap-button-wrapper > div:nth-child(2) > .cap-tile-button').first().click();
